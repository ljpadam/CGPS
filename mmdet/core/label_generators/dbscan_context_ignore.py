...
@torch.no_grad()
def label_generator_dbscan_context_ignore(cfg, features, cuda=True, indep_thres=None, all_inds=None, **kwargs):
    assert cfg.PSEUDO_LABELS.cluster == "dbscan_context_ignore"
