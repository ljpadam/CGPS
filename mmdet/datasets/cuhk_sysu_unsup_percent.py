...
class CUHK_SYSU_UNSUP_PercentDataset(CustomDataset):
    ...
    def generate_unique_ids(self):
        ...
        for i, key in enumerate(self.coco.anns.keys()):
            self.coco.anns[key]['person_id'] = i
            # self.coco.anns[key]['id'] = i
            # print(i)
    ...
    def _parse_ann_info(self, img_info, ann_info):
        ...
        for i, ann in enumerate(ann_info):
            ...
            if ann.get('iscrowd', False):
                ...
                gt_labels.append([self.cat2label[ann['category_id']], ann['person_id'], ann['image_id']])
