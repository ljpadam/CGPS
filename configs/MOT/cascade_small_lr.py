model = dict(
    ...
    rpn_head=dict(
	    ...
	    #scales=[4., 5.4, 7.2, 9.8, 13.2, 17.9, 24.2, 33.0, 44.1, 59.6, 80.0],
            ratios=[2.44],
),
        bbox_coder=dict(
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/raid/ljp/data/MOT/MOT17/mot17half.json',
        img_prefix='/raid/ljp/data/MOT/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/raid/ljp/data/MOT/MOT17/mot17val.json',
        img_prefix='/raid/ljp/data/MOT/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
